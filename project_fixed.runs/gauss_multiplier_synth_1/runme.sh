...
HD_PWD='/home/fpga/project_fixed/project_fixed.runs/gauss_multiplier_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gauss_multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gauss_multiplier.tcl
