...
HD_PWD='/home/fpga/project_fixed/project_fixed.runs/mult_st_multiplier_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_st_multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_st_multiplier.tcl
